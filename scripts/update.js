...
async function main() {
    const existingContractAddress = "0x9fE46736679d2D9a65F0992F2272dE9f3c7fa6e0";  // Replace with your deployed proxy address

    const ContractV2 = await ethers.getContractFactory("DomainRegistryImplementationV2");
    
    // Ensure the new contract is upgradeable to from the V1
